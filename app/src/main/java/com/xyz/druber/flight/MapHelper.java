...
/**
 * Created by SANDEEP on 20/05/2019
 */
...
final class MapHelper {
    static final LatLng LA_LOCATION = new LatLng(17.466967, 78.400028);
    ...
    static PolygonOptions createPolygonWithCircle(Context context, LatLng center, int radius, ArrayList<LatLng> coordinates) {
