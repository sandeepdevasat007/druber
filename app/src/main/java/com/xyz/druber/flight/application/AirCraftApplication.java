...
public class AirCraftApplication extends Application {
    ...
    private static final String TAG = AirCraftApplication.class.getName();
    ...
    private Runnable updateRunnable = new Runnable() {
        @Override
        public void run() {
            LocalBroadcastManager.getInstance(AirCraftApplication.this).sendBroadcast(new Intent(DJIBaseApplication.FLAG_CONNECTION_CHANGE));
